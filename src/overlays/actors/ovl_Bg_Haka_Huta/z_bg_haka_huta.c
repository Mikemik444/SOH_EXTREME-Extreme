    ...
    if (Flags_GetSwitch(play, this->dyna.actor.params) && !Player_InCsMode(play)) {
        ...
        if (this->unk_16A == 2) {
            if (GameInteractor_Should(VB_HAKA_HUTA_SPAWN_KEESE, true, this, play)) {
                MegaSoul_SpawnEnemy(play, &this->dyna.actor, 0, ACTOR_EN_FIREFLY,
                ...
                MegaSoul_SpawnEnemy(play, &this->dyna.actor, 1, ACTOR_EN_FIREFLY,
                            (this->dyna.actor.world.pos.x + (-25.0f) * (Math_CosS(this->dyna.actor.shape.rot.y)) +
            ...
            if (GameInteractor_Should(VB_HAKA_HUTA_SPAWN_REDEAD, true, this, play)) {
                MegaSoul_SpawnEnemy(play, &this->dyna.actor, 0, ACTOR_EN_RD,
