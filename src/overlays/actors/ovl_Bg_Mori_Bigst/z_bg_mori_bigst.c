...
void BgMoriBigst_SetupStalfosFight(BgMoriBigst* this, PlayState* play) {
    ...
    stalfos = MegaSoul_SpawnEnemyChild(play, &this->dyna.actor, 0, ACTOR_EN_TEST, 209.0f, 827.0f, -3320.0f, 0,
                                 0, 0, 1);
    if (stalfos != NULL) {
...
void BgMoriBigst_SetupStalfosPairFight(BgMoriBigst* this, PlayState* play) {
    ...
    if (GameInteractor_Should(VB_MORI_BIGST_SUMMON_STALFOS_PAIR, true, this, play)) {
        stalfos1 = MegaSoul_SpawnEnemyChild(play, &this->dyna.actor, 1, ACTOR_EN_TEST, 70.0f, 827.0f, -3383.0f,
                                      0, 0, 0, 5);
        if (stalfos1 != NULL) {
            this->dyna.actor.child = NULL;
            this->dyna.actor.home.rot.z++;
        ...
        stalfos2 = MegaSoul_SpawnEnemyChild(play, &this->dyna.actor, 2, ACTOR_EN_TEST, 170.0f, 827.0f, -3260.0f,
                                      0, 0, 0, 5);
        if (stalfos2 != NULL) {
            this->dyna.actor.child = NULL;
            this->dyna.actor.home.rot.z++;
