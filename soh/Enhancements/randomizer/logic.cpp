...
bool Logic::HasItem(RandomizerGet itemName) {
    switch (itemName) {
        ...
        case RG_BOMBCHU_10:
        case RG_BOMBCHU_20:
            // Seed-generation logic may treat an accessible Bombchu refill/source
            // as sufficient Bombchu access. The live Check Finder must answer a
            // different question: "Can I perform this check with what Link has
            // RIGHT NOW?"
            //
            // Without this split, reaching Bowling/shops could make every rock
            // check appear unlocked even while the live save had no Bombchus at
            // all. That is exactly the false-positive shown by Zora's River rocks.
            if (CalculatingAvailableChecks) {
                return CheckInventory(ITEM_BOMBCHU, true) && GetAmmo(ITEM_BOMBCHU) > 0;
            }
        ...
        case RG_GORONS_BRACELET:
            return HasItem(RG_POWER_BRACELET) && CurrentUpgrade(UPG_STRENGTH);
        case RG_SILVER_GAUNTLETS:
            return HasItem(RG_POWER_BRACELET) && CurrentUpgrade(UPG_STRENGTH) >= 2;
        case RG_GOLDEN_GAUNTLETS:
            return HasItem(RG_POWER_BRACELET) && CurrentUpgrade(UPG_STRENGTH) >= 3;
        ...
        case RG_NPC_SOUL:
        case RG_ANIMAL_SOUL:
        case RG_ANIMAL_SOUL_COW:
        case RG_ANIMAL_SOUL_CUCCO:
        case RG_ANIMAL_SOUL_DOG:
        case RG_ANIMAL_SOUL_FISH:
        case RG_ANIMAL_SOUL_BUG:
        case RG_ANIMAL_SOUL_BUTTERFLY:
        case RG_ANIMAL_SOUL_FROG:
        case RG_ANIMAL_SOUL_HORSE:
        case RG_ENEMY_SOUL_STALFOS:
        case RG_ENEMY_SOUL_OCTOROK:
        case RG_ENEMY_SOUL_WALLMASTER:
        case RG_ENEMY_SOUL_DODONGO:
        case RG_ENEMY_SOUL_KEESE:
        case RG_ENEMY_SOUL_TEKTITE:
        case RG_ENEMY_SOUL_PEAHAT:
        case RG_ENEMY_SOUL_LIZALFOS_DINOLFOS:
        case RG_ENEMY_SOUL_GOHMA_LARVA:
        case RG_ENEMY_SOUL_SHABOM:
        case RG_ENEMY_SOUL_BABY_DODONGO:
        case RG_ENEMY_SOUL_BIRI_BARI:
        case RG_ENEMY_SOUL_TAILPASARAN:
        case RG_ENEMY_SOUL_TORCH_SLUG:
        case RG_ENEMY_SOUL_MOBLIN:
        case RG_ENEMY_SOUL_ARMOS:
        case RG_ENEMY_SOUL_DEKU_BABA:
        case RG_ENEMY_SOUL_DEKU_SCRUB:
        case RG_ENEMY_SOUL_BUBBLE:
        case RG_ENEMY_SOUL_BEAMOS:
        case RG_ENEMY_SOUL_FLOORMASTER:
        case RG_ENEMY_SOUL_REDEAD_GIBDO:
        case RG_ENEMY_SOUL_FLARE_DANCER:
        case RG_ENEMY_SOUL_DEAD_HAND:
        case RG_ENEMY_SOUL_SHELL_BLADE:
        case RG_ENEMY_SOUL_LIKE_LIKE:
        case RG_ENEMY_SOUL_SPIKE:
        case RG_ENEMY_SOUL_ANUBIS:
        case RG_ENEMY_SOUL_IRON_KNUCKLE:
        case RG_ENEMY_SOUL_SKULL_KID:
        case RG_ENEMY_SOUL_FLYING_POT:
        case RG_ENEMY_SOUL_FREEZARD:
        case RG_ENEMY_SOUL_STINGER:
        case RG_ENEMY_SOUL_WOLFOS:
        case RG_ENEMY_SOUL_GUAY:
        case RG_ENEMY_SOUL_JABU_TENTACLE:
        case RG_ENEMY_SOUL_DARK_LINK:
        case RG_ENEMY_SOUL_DOOR_TRAP:
        case RG_ENEMY_SOUL_FLYING_FLOOR_TILE:
        case RG_ENEMY_SOUL_GERUDO_THIEF:
        case RG_ENEMY_SOUL_POE_SISTER:
        case RG_ENEMY_SOUL_POE:
        case RG_ENEMY_SOUL_LEEVER:
        case RG_ENEMY_SOUL_STALCHILD:
        case RG_ENEMY_SOUL_BIG_OCTO:
        case RG_POT_SOUL:
        case RG_CRATE_SOUL:
        case RG_GRASS_SOUL:
        case RG_ROCK_SOUL:
...
static RandomizerGet EnemySoulItemForLogicEnemy(RandomizerEnemy enemy) {
    switch (enemy) {
        case RE_STALFOS: return RG_ENEMY_SOUL_STALFOS;
        case RE_OCTOROK: return RG_ENEMY_SOUL_OCTOROK;
        case RE_WALLMASTER: return RG_ENEMY_SOUL_WALLMASTER;
        case RE_DODONGO: return RG_ENEMY_SOUL_DODONGO;
        case RE_KEESE:
        case RE_FIRE_KEESE: return RG_ENEMY_SOUL_KEESE;
        case RE_LIZALFOS:
        case RE_DINOLFOS: return RG_ENEMY_SOUL_LIZALFOS_DINOLFOS;
        case RE_GOHMA_LARVA: return RG_ENEMY_SOUL_GOHMA_LARVA;
        case RE_SHABOM: return RG_ENEMY_SOUL_SHABOM;
        case RE_BARI: return RG_ENEMY_SOUL_BIRI_BARI;
        case RE_TORCH_SLUG: return RG_ENEMY_SOUL_TORCH_SLUG;
        case RE_ARMOS: return RG_ENEMY_SOUL_ARMOS;
        case RE_DEKU_BABA:
        case RE_WITHERED_DEKU_BABA: return RG_ENEMY_SOUL_DEKU_BABA;
        case RE_MAD_SCRUB: return RG_ENEMY_SOUL_DEKU_SCRUB;
        case RE_BLUE_BUBBLE:
        case RE_GREEN_BUBBLE: return RG_ENEMY_SOUL_BUBBLE;
        case RE_BEAMOS: return RG_ENEMY_SOUL_BEAMOS;
        case RE_FLOORMASTER: return RG_ENEMY_SOUL_FLOORMASTER;
        case RE_REDEAD:
        case RE_GIBDO: return RG_ENEMY_SOUL_REDEAD_GIBDO;
        case RE_FLARE_DANCER: return RG_ENEMY_SOUL_FLARE_DANCER;
        case RE_DEAD_HAND: return RG_ENEMY_SOUL_DEAD_HAND;
        case RE_SHELL_BLADE: return RG_ENEMY_SOUL_SHELL_BLADE;
        case RE_LIKE_LIKE: return RG_ENEMY_SOUL_LIKE_LIKE;
        case RE_SPIKE: return RG_ENEMY_SOUL_SPIKE;
        case RE_ANUBIS: return RG_ENEMY_SOUL_ANUBIS;
        case RE_IRON_KNUCKLE: return RG_ENEMY_SOUL_IRON_KNUCKLE;
        case RE_FREEZARD: return RG_ENEMY_SOUL_FREEZARD;
        case RE_STINGER: return RG_ENEMY_SOUL_STINGER;
        case RE_WOLFOS:
        case RE_WHITE_WOLFOS: return RG_ENEMY_SOUL_WOLFOS;
        case RE_GUAY: return RG_ENEMY_SOUL_GUAY;
        case RE_TENTACLE: return RG_ENEMY_SOUL_JABU_TENTACLE;
        case RE_DARK_LINK: return RG_ENEMY_SOUL_DARK_LINK;
        case RE_GERUDO_WARRIOR: return RG_ENEMY_SOUL_GERUDO_THIEF;
        case RE_POE: return RG_ENEMY_SOUL_POE;
        case RE_MEG: return RG_ENEMY_SOUL_POE_SISTER;
        case RE_BIG_OCTO: return RG_ENEMY_SOUL_BIG_OCTO;
        case RE_PURPLE_LEEVER: return RG_ENEMY_SOUL_LEEVER;
...
bool Logic::CanKillEnemy(RandomizerEnemy enemy, EnemyDistance distance, bool wallOrFloor, uint8_t quantity, bool timer,
                         bool inWater) {
    if ((enemy == RE_GOLD_SKULLTULA || enemy == RE_BIG_SKULLTULA || enemy == RE_WALLTULA) && ctx->GetOption(RSK_SHUFFLE_SKULLTULA_SOUL) && !HasItem(RG_SKULLTULA_SOUL)) {
        return false;
    }

    if (enemy != RE_GOLD_SKULLTULA && enemy != RE_BIG_SKULLTULA && enemy != RE_WALLTULA) {
        const int enemySoulMode = ctx->GetOption(RSK_SHUFFLE_ENEMY_SOUL).Get();
        if (enemySoulMode == 1 && !HasItem(RG_ENEMY_SOUL)) {
            return false;
        }
        if (enemySoulMode == 2) {
            const RandomizerGet individualSoul = EnemySoulItemForLogicEnemy(enemy);
            if (individualSoul != RG_NONE && !HasItem(individualSoul)) {
                return false;
            }
        }
    }
...
bool Logic::ScarecrowsSong() {
    // Knowing the tune never substitutes for a usable instrument/buttons.
    return CanUse(RG_FAIRY_OCARINA) && OcarinaButtons() >= 2 &&
           (ctx->GetOption(RSK_SKIP_SCARECROWS_SONG) ||
...
bool Logic::CanBreakCrates() {
    // Crate Soul only unlocks the crate. It does NOT provide a way to break it.
    if (ctx->GetOption(RSK_SHUFFLE_CRATE_SOUL) && !HasItem(RG_CRATE_SOUL)) {
        return false;
    }

    // Large/fixed crates can be broken by rolling into them or by a heavy/
    // explosive break method. When Roll is not shuffled, Link has it innately.
    const bool canRoll =
        !ctx->GetOption(RSK_SHUFFLE_ROLL) || HasItem(RG_ROLL);

    return canRoll || HasExplosives() || CanUse(RG_MEGATON_HAMMER);
}

bool Logic::CanBreakSmallCrates() {
    // Small crates use the same Soul gate, but also support their normal extra
    // interactions: jumpslash and lifting/throwing with the shuffled Grab ability.
    if (ctx->GetOption(RSK_SHUFFLE_CRATE_SOUL) && !HasItem(RG_CRATE_SOUL)) {
        return false;
    }
    ...
    return canRoll || CanJumpslash() || HasExplosives() ||
...
bool Logic::HasExplosives() {
    // During live Available Checks, CanUse(RG_BOMBCHU_5) is deliberately backed
    // by the CURRENT Bombchu inventory/ammo instead of theoretical refill access.
    // Bomb Bag already reads the live owned upgrade from SaveContext.
...
// Collecting an En_Kusa placement may use destruction OR lifting/throwing.
// Resource events that specifically need a cut still use CanCutShrubs().
...
bool Logic::CanOpenBombGrotto() {
    // SOH-EXTREME: Shovel gates every grotto, while a bomb/rock-hidden grotto
    // still has its physical rock/boulder blocker.  That blocker cannot be
    // removed until Rock / Boulder Soul is owned, and the allowed removal
    // methods are the EXTREME rock rule: explosives OR Grab/Power Bracelet.
    if (ctx->GetOption(RSK_SHUFFLE_SHOVEL) && !HasItem(RG_SHOVEL)) {
        return false;
    }
    return CanBreakRocks() && (HasItem(RG_STONE_OF_AGONY) || ctx->GetTrickOption(RT_GROTTOS_WITHOUT_AGONY));
}
...
std::map<RandomizerGet, uint32_t> StaticData::RandoGetToRandInf = {
    ...
    { RG_ANIMAL_SOUL_COW, RAND_INF_ANIMAL_SOUL_COW },
    { RG_ANIMAL_SOUL_CUCCO, RAND_INF_ANIMAL_SOUL_CUCCO },
    { RG_ANIMAL_SOUL_DOG, RAND_INF_ANIMAL_SOUL_DOG },
    { RG_ANIMAL_SOUL_FISH, RAND_INF_ANIMAL_SOUL_FISH },
    { RG_ANIMAL_SOUL_BUG, RAND_INF_ANIMAL_SOUL_BUG },
    { RG_ANIMAL_SOUL_BUTTERFLY, RAND_INF_ANIMAL_SOUL_BUTTERFLY },
    { RG_ANIMAL_SOUL_FROG, RAND_INF_ANIMAL_SOUL_FROG },
    { RG_ANIMAL_SOUL_HORSE, RAND_INF_ANIMAL_SOUL_HORSE },
    { RG_ENEMY_SOUL_STALFOS, RAND_INF_ENEMY_SOUL_STALFOS },
    { RG_ENEMY_SOUL_OCTOROK, RAND_INF_ENEMY_SOUL_OCTOROK },
    { RG_ENEMY_SOUL_WALLMASTER, RAND_INF_ENEMY_SOUL_WALLMASTER },
    { RG_ENEMY_SOUL_DODONGO, RAND_INF_ENEMY_SOUL_DODONGO },
    { RG_ENEMY_SOUL_KEESE, RAND_INF_ENEMY_SOUL_KEESE },
    { RG_ENEMY_SOUL_TEKTITE, RAND_INF_ENEMY_SOUL_TEKTITE },
    { RG_ENEMY_SOUL_PEAHAT, RAND_INF_ENEMY_SOUL_PEAHAT },
    { RG_ENEMY_SOUL_LIZALFOS_DINOLFOS, RAND_INF_ENEMY_SOUL_LIZALFOS_DINOLFOS },
    { RG_ENEMY_SOUL_GOHMA_LARVA, RAND_INF_ENEMY_SOUL_GOHMA_LARVA },
    { RG_ENEMY_SOUL_SHABOM, RAND_INF_ENEMY_SOUL_SHABOM },
    { RG_ENEMY_SOUL_BABY_DODONGO, RAND_INF_ENEMY_SOUL_BABY_DODONGO },
    { RG_ENEMY_SOUL_BIRI_BARI, RAND_INF_ENEMY_SOUL_BIRI_BARI },
    { RG_ENEMY_SOUL_TAILPASARAN, RAND_INF_ENEMY_SOUL_TAILPASARAN },
    { RG_ENEMY_SOUL_TORCH_SLUG, RAND_INF_ENEMY_SOUL_TORCH_SLUG },
    { RG_ENEMY_SOUL_MOBLIN, RAND_INF_ENEMY_SOUL_MOBLIN },
    { RG_ENEMY_SOUL_ARMOS, RAND_INF_ENEMY_SOUL_ARMOS },
    { RG_ENEMY_SOUL_DEKU_BABA, RAND_INF_ENEMY_SOUL_DEKU_BABA },
    { RG_ENEMY_SOUL_DEKU_SCRUB, RAND_INF_ENEMY_SOUL_DEKU_SCRUB },
    { RG_ENEMY_SOUL_BUBBLE, RAND_INF_ENEMY_SOUL_BUBBLE },
    { RG_ENEMY_SOUL_BEAMOS, RAND_INF_ENEMY_SOUL_BEAMOS },
    { RG_ENEMY_SOUL_FLOORMASTER, RAND_INF_ENEMY_SOUL_FLOORMASTER },
    { RG_ENEMY_SOUL_REDEAD_GIBDO, RAND_INF_ENEMY_SOUL_REDEAD_GIBDO },
    { RG_ENEMY_SOUL_FLARE_DANCER, RAND_INF_ENEMY_SOUL_FLARE_DANCER },
    { RG_ENEMY_SOUL_DEAD_HAND, RAND_INF_ENEMY_SOUL_DEAD_HAND },
    { RG_ENEMY_SOUL_SHELL_BLADE, RAND_INF_ENEMY_SOUL_SHELL_BLADE },
    { RG_ENEMY_SOUL_LIKE_LIKE, RAND_INF_ENEMY_SOUL_LIKE_LIKE },
    { RG_ENEMY_SOUL_SPIKE, RAND_INF_ENEMY_SOUL_SPIKE },
    { RG_ENEMY_SOUL_ANUBIS, RAND_INF_ENEMY_SOUL_ANUBIS },
    { RG_ENEMY_SOUL_IRON_KNUCKLE, RAND_INF_ENEMY_SOUL_IRON_KNUCKLE },
    { RG_ENEMY_SOUL_SKULL_KID, RAND_INF_ENEMY_SOUL_SKULL_KID },
    { RG_ENEMY_SOUL_FLYING_POT, RAND_INF_ENEMY_SOUL_FLYING_POT },
    { RG_ENEMY_SOUL_FREEZARD, RAND_INF_ENEMY_SOUL_FREEZARD },
    { RG_ENEMY_SOUL_STINGER, RAND_INF_ENEMY_SOUL_STINGER },
    { RG_ENEMY_SOUL_WOLFOS, RAND_INF_ENEMY_SOUL_WOLFOS },
    { RG_ENEMY_SOUL_GUAY, RAND_INF_ENEMY_SOUL_GUAY },
    { RG_ENEMY_SOUL_JABU_TENTACLE, RAND_INF_ENEMY_SOUL_JABU_TENTACLE },
    { RG_ENEMY_SOUL_DARK_LINK, RAND_INF_ENEMY_SOUL_DARK_LINK },
    { RG_ENEMY_SOUL_DOOR_TRAP, RAND_INF_ENEMY_SOUL_DOOR_TRAP },
    { RG_ENEMY_SOUL_FLYING_FLOOR_TILE, RAND_INF_ENEMY_SOUL_FLYING_FLOOR_TILE },
    { RG_ENEMY_SOUL_GERUDO_THIEF, RAND_INF_ENEMY_SOUL_GERUDO_THIEF },
    { RG_ENEMY_SOUL_POE_SISTER, RAND_INF_ENEMY_SOUL_POE_SISTER },
    { RG_ENEMY_SOUL_POE, RAND_INF_ENEMY_SOUL_POE },
    { RG_ENEMY_SOUL_LEEVER, RAND_INF_ENEMY_SOUL_LEEVER },
    { RG_ENEMY_SOUL_STALCHILD, RAND_INF_ENEMY_SOUL_STALCHILD },
    { RG_ENEMY_SOUL_BIG_OCTO, RAND_INF_ENEMY_SOUL_BIG_OCTO },
...
bool Logic::SummonEpona() {
    return HasAnimalSoul(RG_ANIMAL_SOUL_HORSE) && IsAdult && Get(LOGIC_FREED_EPONA) && CanUse(RG_EPONAS_SONG);
}
