...
static WidgetInfo animalSoulsTracking;
static WidgetInfo enemySoulsTracking;
...
std::vector<ItemTrackerItem> flowOfTimeItems = {
    ITEM_TRACKER_RG_CUSTOM(RG_FLOW_OF_TIME, "TIME", ITEM_SONG_SUN, 0, DrawItem),
};
...
std::vector<ItemTrackerItem> animalSoulItems = {
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_COW, "COW", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_CUCCO, "CUCCO", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_DOG, "DOG", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_FISH, "FISH", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_BUG, "BUG", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_BUTTERFLY, "BUTTER", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_FROG, "FROG", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ANIMAL_SOUL_HORSE, "HORSE", 0, DrawItem),
};

std::vector<ItemTrackerItem> enemySoulItems = {
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_STALFOS, "STAL", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_OCTOROK, "OCTO", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_WALLMASTER, "WALL", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_DODONGO, "DOD", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_KEESE, "KEESE", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_TEKTITE, "TEK", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_PEAHAT, "PEA", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_LIZALFOS_DINOLFOS, "LIZ", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_GOHMA_LARVA, "LARVA", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_SHABOM, "SHAB", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_BABY_DODONGO, "BABY", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_BIRI_BARI, "BIRI", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_TAILPASARAN, "TAIL", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_TORCH_SLUG, "SLUG", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_MOBLIN, "MOB", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_ARMOS, "ARMOS", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_DEKU_BABA, "BABA", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_DEKU_SCRUB, "DSCRUB", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_BUBBLE, "BUB", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_BEAMOS, "BEAM", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_FLOORMASTER, "FLOOR", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_REDEAD_GIBDO, "DEAD", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_FLARE_DANCER, "FLARE", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_DEAD_HAND, "HAND", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_SHELL_BLADE, "SHELL", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_LIKE_LIKE, "LIKE", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_SPIKE, "SPIKE", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_ANUBIS, "ANUB", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_IRON_KNUCKLE, "IK", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_SKULL_KID, "SKID", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_FLYING_POT, "FPOT", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_FREEZARD, "FREEZ", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_STINGER, "STING", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_WOLFOS, "WOLF", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_GUAY, "GUAY", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_JABU_TENTACLE, "TENT", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_DARK_LINK, "DLINK", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_DOOR_TRAP, "DOOR", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_FLYING_FLOOR_TILE, "TILE", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_GERUDO_THIEF, "THIEF", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_POE_SISTER, "SISTR", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_POE, "POE", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_LEEVER, "LEEV", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_STALCHILD, "STALC", 0, DrawItem),
    ITEM_TRACKER_RG(RG_ENEMY_SOUL_BIG_OCTO, "BOCTO", 0, DrawItem),

    // Skulltula Soul is a dedicated SOH-EXTREME Soul rather than one of the
    // individual Enemy Soul enum entries, but it governs ordinary Skulltulas and
    // Gold Skulltulas.  Show it in the Enemy Soul tracker so ownership is obvious.
    ITEM_TRACKER_RG(RG_SKULLTULA_SOUL, "SKULL", 0, DrawItem),
};
...
static void TrackMegaSouls(std::vector<ItemTrackerItem>* trackList) {
    for (auto soul : megaSoulItems) {
        ...
        switch (soul.id) {
            case RG_ENEMY_SOUL:
                enabled = IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_ENEMY_SOUL).Is(1);
                break;
            case RG_NPC_SOUL:
                enabled = IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_NPC_SOUL);
                break;
            case RG_ANIMAL_SOUL:
                enabled = IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_ANIMAL_SOUL).Is(1);
                break;
            case RG_POT_SOUL:
...
void TrackAnimalSouls(std::vector<ItemTrackerItem>* trackList) {
    if (IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_ANIMAL_SOUL).Is(2)) {
        trackList->insert(trackList->end(), animalSoulItems.begin(), animalSoulItems.end());
    }
}

void TrackEnemySouls(std::vector<ItemTrackerItem>* trackList) {
    if (IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_ENEMY_SOUL).Is(2)) {
        trackList->insert(trackList->end(), enemySoulItems.begin(), enemySoulItems.end());
    }
}
    ...
    if (item.kind == ITEM_KIND_ITEM) {
        ...
        switch (item.id) {
            ...
            case RG_FLOW_OF_TIME:
                itemName = "Flow of Time";
                break;
            case RG_ANIMAL_SOUL_COW: itemName = "Cow Soul"; break;
            case RG_ANIMAL_SOUL_CUCCO: itemName = "Cucco Soul"; break;
            case RG_ANIMAL_SOUL_DOG: itemName = "Dog Soul"; break;
            case RG_ANIMAL_SOUL_FISH: itemName = "Fish Soul"; break;
            case RG_ANIMAL_SOUL_BUG: itemName = "Bug Soul"; break;
            case RG_ANIMAL_SOUL_BUTTERFLY: itemName = "Butterfly Soul"; break;
            case RG_ANIMAL_SOUL_FROG: itemName = "Frog Soul"; break;
            case RG_ANIMAL_SOUL_HORSE: itemName = "Horse Soul"; break;
            case RG_ENEMY_SOUL_STALFOS: itemName = "Stalfos Soul"; break;
            case RG_ENEMY_SOUL_OCTOROK: itemName = "Octorok Soul"; break;
            case RG_ENEMY_SOUL_WALLMASTER: itemName = "Wallmaster Soul"; break;
            case RG_ENEMY_SOUL_DODONGO: itemName = "Dodongo Soul"; break;
            case RG_ENEMY_SOUL_KEESE: itemName = "Keese Soul"; break;
            case RG_ENEMY_SOUL_TEKTITE: itemName = "Tektite Soul"; break;
            case RG_ENEMY_SOUL_PEAHAT: itemName = "Peahat Soul"; break;
            case RG_ENEMY_SOUL_LIZALFOS_DINOLFOS: itemName = "Lizalfos and Dinolfos Soul"; break;
            case RG_ENEMY_SOUL_GOHMA_LARVA: itemName = "Gohma Larva Soul"; break;
            case RG_ENEMY_SOUL_SHABOM: itemName = "Shabom Soul"; break;
            case RG_ENEMY_SOUL_BABY_DODONGO: itemName = "Baby Dodongo Soul"; break;
            case RG_ENEMY_SOUL_BIRI_BARI: itemName = "Biri and Bari Soul"; break;
            case RG_ENEMY_SOUL_TAILPASARAN: itemName = "Tailpasaran Soul"; break;
            case RG_ENEMY_SOUL_TORCH_SLUG: itemName = "Torch Slug Soul"; break;
            case RG_ENEMY_SOUL_MOBLIN: itemName = "Moblin Soul"; break;
            case RG_ENEMY_SOUL_ARMOS: itemName = "Armos Soul"; break;
            case RG_ENEMY_SOUL_DEKU_BABA: itemName = "Deku Baba Soul"; break;
            case RG_ENEMY_SOUL_DEKU_SCRUB: itemName = "Deku Scrub Soul"; break;
            case RG_ENEMY_SOUL_BUBBLE: itemName = "Bubble Soul"; break;
            case RG_ENEMY_SOUL_BEAMOS: itemName = "Beamos Soul"; break;
            case RG_ENEMY_SOUL_FLOORMASTER: itemName = "Floormaster Soul"; break;
            case RG_ENEMY_SOUL_REDEAD_GIBDO: itemName = "Redead and Gibdo Soul"; break;
            case RG_ENEMY_SOUL_FLARE_DANCER: itemName = "Flare Dancer Soul"; break;
            case RG_ENEMY_SOUL_DEAD_HAND: itemName = "Dead Hand Soul"; break;
            case RG_ENEMY_SOUL_SHELL_BLADE: itemName = "Shell Blade Soul"; break;
            case RG_ENEMY_SOUL_LIKE_LIKE: itemName = "Like Like Soul"; break;
            case RG_ENEMY_SOUL_SPIKE: itemName = "Spike Soul"; break;
            case RG_ENEMY_SOUL_ANUBIS: itemName = "Anubis Soul"; break;
            case RG_ENEMY_SOUL_IRON_KNUCKLE: itemName = "Iron Knuckle Soul"; break;
            case RG_ENEMY_SOUL_SKULL_KID: itemName = "Skull Kid Soul"; break;
            case RG_ENEMY_SOUL_FLYING_POT: itemName = "Flying Pot Soul"; break;
            case RG_ENEMY_SOUL_FREEZARD: itemName = "Freezard Soul"; break;
            case RG_ENEMY_SOUL_STINGER: itemName = "Stinger Soul"; break;
            case RG_ENEMY_SOUL_WOLFOS: itemName = "Wolfos Soul"; break;
            case RG_ENEMY_SOUL_GUAY: itemName = "Guay Soul"; break;
            case RG_ENEMY_SOUL_JABU_TENTACLE: itemName = "Jabu Jabu Tentacle Soul"; break;
            case RG_ENEMY_SOUL_DARK_LINK: itemName = "Dark Link Soul"; break;
            case RG_ENEMY_SOUL_DOOR_TRAP: itemName = "Door Trap Soul"; break;
            case RG_ENEMY_SOUL_FLYING_FLOOR_TILE: itemName = "Flying Floor Tile Soul"; break;
            case RG_ENEMY_SOUL_GERUDO_THIEF: itemName = "Gerudo Thief Soul"; break;
            case RG_ENEMY_SOUL_POE_SISTER: itemName = "Poe Sister Soul"; break;
            case RG_ENEMY_SOUL_POE: itemName = "Poe Soul"; break;
            case RG_ENEMY_SOUL_LEEVER: itemName = "Leever Soul"; break;
            case RG_ENEMY_SOUL_STALCHILD: itemName = "Stalchild Soul"; break;
            case RG_ENEMY_SOUL_BIG_OCTO: itemName = "Big Octo Soul"; break;
...
static int32_t MegaSoulsDisplay() {
    const bool anyMegaSoul =
        IS_RANDO && (RAND_GET_OPTION(RSK_SHUFFLE_ENEMY_SOUL).Is(1) || RAND_GET_OPTION(RSK_SHUFFLE_NPC_SOUL) ||
                     RAND_GET_OPTION(RSK_SHUFFLE_ANIMAL_SOUL).Is(1) || RAND_GET_OPTION(RSK_SHUFFLE_POT_SOUL) ||
                     ...
                     RAND_GET_OPTION(RSK_SHUFFLE_SKULLTULA_SOUL) || RAND_GET_OPTION(RSK_SHUFFLE_BUSINESS_SCRUB_SOUL) ||
                     RAND_GET_OPTION(RSK_SHUFFLE_SHOVEL));
    return GetGatedSectionDisplay(CVAR_TRACKER_ITEM("DisplayType.MegaSouls"), anyMegaSoul);
}

static int32_t AnimalSoulsDisplay() {
    return GetGatedSectionDisplay(CVAR_TRACKER_ITEM("DisplayType.AnimalSouls"),
                                  IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_ANIMAL_SOUL).Is(2));
}

static int32_t EnemySoulsDisplay() {
    return GetGatedSectionDisplay(CVAR_TRACKER_ITEM("DisplayType.EnemySouls"),
                                  IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_ENEMY_SOUL).Is(2));
}
...
void UpdateVectors() {
    ...
    if (IS_RANDO && RAND_GET_OPTION(RSK_SHUFFLE_FLOW_OF_TIME)) {
        mainWindowItems.insert(mainWindowItems.end(), flowOfTimeItems.begin(), flowOfTimeItems.end());
    }
    ...
    if (AnimalSoulsDisplay() == SECTION_DISPLAY_MAIN_WINDOW) {
        while (mainWindowItems.size() % 6) {
            mainWindowItems.push_back(ITEM_TRACKER_ITEM(ITEM_NONE, "", 0, DrawItem));
        }
        TrackAnimalSouls(&mainWindowItems);
    }

    if (EnemySoulsDisplay() == SECTION_DISPLAY_MAIN_WINDOW) {
        while (mainWindowItems.size() % 6) {
            mainWindowItems.push_back(ITEM_TRACKER_ITEM(ITEM_NONE, "", 0, DrawItem));
        }
        TrackEnemySouls(&mainWindowItems);
    }
...
void ItemTrackerWindow::DrawElement() {
    ...
    if (CVarGetInteger(CVAR_TRACKER_ITEM("WindowType"), TRACKER_WINDOW_FLOATING) == TRACKER_WINDOW_WINDOW ||
        ...
        if ((CVarGetInteger(CVAR_TRACKER_ITEM("DisplayType.Inventory"), SECTION_DISPLAY_MAIN_WINDOW) ==
            ...
            (MegaSoulsDisplay() == SECTION_DISPLAY_MAIN_WINDOW) ||
            (AnimalSoulsDisplay() == SECTION_DISPLAY_MAIN_WINDOW) ||
            (EnemySoulsDisplay() == SECTION_DISPLAY_MAIN_WINDOW) ||
        ...
        if (AnimalSoulsDisplay() == SECTION_DISPLAY_SEPARATE) {
            BeginFloatingWindows("Animal Soul Tracker");
            DrawItemsInRows(animalSoulItems, 4);
            Trackers::EndFloatWindows();
        }

        if (EnemySoulsDisplay() == SECTION_DISPLAY_SEPARATE) {
            BeginFloatingWindows("Enemy Soul Tracker");
            DrawItemsInRows(enemySoulItems, 8);
            Trackers::EndFloatWindows();
        }
...
void ItemTrackerSettingsWindow::DrawElement() {
    ...
    if (ImGui::BeginTable("itemTrackerSettingsTable", 2, ImGuiTableFlags_BordersH | ImGuiTableFlags_BordersV)) {
        ...
        SohGui::mSohMenu->MenuDrawItem(animalSoulsTracking, 250, THEME_COLOR);
        SohGui::mSohMenu->MenuDrawItem(enemySoulsTracking, 250, THEME_COLOR);
...
void RegisterItemTrackerWidgets() {
    ...
    animalSoulsTracking = { .name = "Individual Animal Souls", .type = WidgetType::WIDGET_CVAR_COMBOBOX };
    animalSoulsTracking.CVar(CVAR_TRACKER_ITEM("DisplayType.AnimalSouls"))
        .Options(ComboboxOptions()
                     .DefaultIndex(SECTION_DISPLAY_MAIN_WINDOW)
                     .ComponentAlignment(ComponentAlignments::Right)
                     .LabelPosition(LabelPositions::Far)
        ...
        .Callback([](WidgetInfo& info) { RefreshItemTrackerMainWindow(); });
    SohGui::mSohMenu->AddSearchWidget(
        { animalSoulsTracking, "Randomizer", "Item Tracker", "General Settings", "animal soul cucco cow dog fish" });

    enemySoulsTracking = { .name = "Individual Enemy Souls", .type = WidgetType::WIDGET_CVAR_COMBOBOX };
    enemySoulsTracking.CVar(CVAR_TRACKER_ITEM("DisplayType.EnemySouls"))
        .Options(ComboboxOptions()
                     .DefaultIndex(SECTION_DISPLAY_MAIN_WINDOW)
                     .ComponentAlignment(ComponentAlignments::Right)
                     .LabelPosition(LabelPositions::Far)
        ...
        .Callback([](WidgetInfo& info) { RefreshItemTrackerMainWindow(); });
    SohGui::mSohMenu->AddSearchWidget(
        { enemySoulsTracking, "Randomizer", "Item Tracker", "General Settings", "enemy soul stalfos keese" });
