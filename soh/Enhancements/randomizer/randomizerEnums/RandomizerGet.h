...
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_COW)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_CUCCO)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_DOG)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_FISH)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_BUG)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_BUTTERFLY)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_FROG)
RANDO_ENUM_ITEM(RG_ANIMAL_SOUL_HORSE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_STALFOS)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_OCTOROK)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_WALLMASTER)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_DODONGO)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_KEESE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_TEKTITE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_PEAHAT)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_LIZALFOS_DINOLFOS)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_GOHMA_LARVA)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_SHABOM)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_BABY_DODONGO)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_BIRI_BARI)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_TAILPASARAN)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_TORCH_SLUG)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_MOBLIN)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_ARMOS)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_DEKU_BABA)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_DEKU_SCRUB)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_BUBBLE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_BEAMOS)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_FLOORMASTER)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_REDEAD_GIBDO)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_FLARE_DANCER)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_DEAD_HAND)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_SHELL_BLADE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_LIKE_LIKE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_SPIKE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_ANUBIS)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_IRON_KNUCKLE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_SKULL_KID)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_FLYING_POT)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_FREEZARD)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_STINGER)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_WOLFOS)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_GUAY)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_JABU_TENTACLE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_DARK_LINK)
...
// 0.7.86: remaining finite vanilla enemy categories
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_DOOR_TRAP)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_FLYING_FLOOR_TILE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_GERUDO_THIEF)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_POE_SISTER)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_POE)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_LEEVER)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_STALCHILD)
RANDO_ENUM_ITEM(RG_ENEMY_SOUL_BIG_OCTO)
