...
void RegionTable_Init_HyruleField() {
    ...
    areaTable[RR_HYRULE_FIELD] = Region("Hyrule Field", SCENE_HYRULE_FIELD, {
        ...
        LOCATION(RC_HF_CENTRAL_GRASS_1,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_2,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_3,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_4,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_5,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_6,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_7,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_8,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_9,            logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_10,           logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_11,           logic->CanCollectGrass()),
        LOCATION(RC_HF_CENTRAL_GRASS_12,           logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_1,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_2,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_3,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_4,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_5,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_6,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_7,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_8,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_9,              logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_10,             logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_11,             logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTH_GRASS_12,             logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_1,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_2,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_3,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_4,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_5,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_6,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_7,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_8,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_9,        logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_10,       logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_11,       logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GRASS_12,       logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_1,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_2,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_3,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_4,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_5,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_6,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_7,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_8,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_9,            logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_10,           logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_11,           logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_KF_GRASS_12,           logic->CanCollectGrass()),
        ...
        LOCATION(RC_HF_CENTER_EXIT_ARROW_SIGN,     logic->HasItem(RG_CLIMB) && logic->CanRead()),
        ...
        ENTRANCE(RR_MARKET_ENTRANCE,        logic->IsAdult || logic->AtDay),
        ENTRANCE(RR_KAKARIKO_VILLAGE,       true),
        ENTRANCE(RR_ZR_FRONT,               true),
        ENTRANCE(RR_LON_LON_RANCH,          true),
        ENTRANCE(RR_HF_SOUTHEAST_GROTTO,    AnyAgeTime([]{return logic->CanBreakRocks();})),
        ...
        ENTRANCE(RR_HF_NEAR_MARKET_GROTTO,  AnyAgeTime([]{return logic->CanBreakRocks();})),
        ENTRANCE(RR_HF_FAIRY_GROTTO,        AnyAgeTime([]{return logic->CanBreakRocks();})),
    ...
    areaTable[RR_HF_SOUTHEAST_GROTTO] = Region("HF Southeast Grotto", SCENE_GROTTOS, grottoEvents, {
        ...
        LOCATION(RC_HF_SOUTHEAST_GROTTO_GRASS_1,                 logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTHEAST_GROTTO_GRASS_2,                 logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTHEAST_GROTTO_GRASS_3,                 logic->CanCollectGrass()),
        LOCATION(RC_HF_SOUTHEAST_GROTTO_GRASS_4,                 logic->CanCollectGrass()),
    ...
    areaTable[RR_HF_OPEN_GROTTO] = Region("HF Open Grotto", SCENE_GROTTOS, grottoEvents, {
        ...
        LOCATION(RC_HF_OPEN_GROTTO_GRASS_1,                logic->CanCollectGrass()),
        LOCATION(RC_HF_OPEN_GROTTO_GRASS_2,                logic->CanCollectGrass()),
        LOCATION(RC_HF_OPEN_GROTTO_GRASS_3,                logic->CanCollectGrass()),
        LOCATION(RC_HF_OPEN_GROTTO_GRASS_4,                logic->CanCollectGrass()),
    ...
    areaTable[RR_HF_COW_GROTTO_BEHIND_WEBS] = Region("HF Cow Grotto Behind Webs", SCENE_GROTTOS, {
        ...
        LOCATION(RC_HF_COW_GROTTO_COW, logic->HasAnimalSoul(RG_ANIMAL_SOUL_COW) &&                    logic->CanUse(RG_EPONAS_SONG)),
        ...
        LOCATION(RC_HF_COW_GROTTO_GRASS_1,                logic->CanCollectGrass()),
        LOCATION(RC_HF_COW_GROTTO_GRASS_2,                logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_HF_NEAR_MARKET_GROTTO] = Region("HF Near Market Grotto", SCENE_GROTTOS, grottoEvents, {
        ...
        LOCATION(RC_HF_NEAR_MARKET_GROTTO_GRASS_1,                logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GROTTO_GRASS_2,                logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GROTTO_GRASS_3,                logic->CanCollectGrass()),
        LOCATION(RC_HF_NEAR_MARKET_GROTTO_GRASS_4,                logic->CanCollectGrass()),
