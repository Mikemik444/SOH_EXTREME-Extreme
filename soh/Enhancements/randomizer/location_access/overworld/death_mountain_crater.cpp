...
void RegionTable_Init_DeathMountainCrater() {
    ...
    areaTable[RR_DMC_ROCK_GROTTO] = Region("DMC Rock Grotto", SCENE_DEATH_MOUNTAIN_CRATER, {}, {
        ...
        //Exits
        ENTRANCE(RR_DMC_UPPER_GROTTO, AnyAgeTime([]{return logic->CanBreakRocks();})),
    });
    ...
    areaTable[RR_DMC_POT_GROTTO_EXIT] = Region("DMC Pot Grotto Exit", SCENE_DEATH_MOUNTAIN_CRATER, {}, {}, {
        ...
        ENTRANCE(RR_DMC_SCRUB_GROTTO, logic->CanBreakRocks()),
    });
    ...
    areaTable[RR_DMC_CENTRAL] = Region("DMC Central", SCENE_DEATH_MOUNTAIN_CRATER, {
        ...
        //Locations
        LOCATION(RC_SHEIK_IN_CRATER,                    (logic->IsAdult) && (!ctx->GetOption(RSK_SHUFFLE_NPC_SOUL) || logic->HasItem(RG_NPC_SOUL)) && (!ctx->GetOption(RSK_SHUFFLE_SPEAK) || logic->HasItem(RG_SPEAK_HYLIAN))),
    ...
    areaTable[RR_DMC_UPPER_GROTTO] = Region("DMC Upper Grotto", SCENE_GROTTOS, grottoEvents, {
        ...
        LOCATION(RC_DMC_UPPER_GROTTO_GRASS_1,                 logic->CanCollectGrass()),
        LOCATION(RC_DMC_UPPER_GROTTO_GRASS_2,                 logic->CanCollectGrass()),
        LOCATION(RC_DMC_UPPER_GROTTO_GRASS_3,                 logic->CanCollectGrass()),
        LOCATION(RC_DMC_UPPER_GROTTO_GRASS_4,                 logic->CanCollectGrass()),
