...
void RegionTable_Init_KokiriForest() {
    ...
    areaTable[RR_KOKIRI_FOREST] = Region("Kokiri Forest", SCENE_KOKIRI_FOREST, {
        ...
        LOCATION(RC_KF_CHILD_GRASS_1,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_2,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_3,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_4,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_5,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_6,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_7,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_8,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_9,                         logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_10,                        logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_11,                        logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_12,                        logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_1,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_2,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_3,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_4,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_5,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_6,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_7,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_8,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_9,                         logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_10,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_11,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_12,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_13,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_14,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_15,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_16,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_17,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_18,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_19,                        logic->IsAdult && logic->CanCollectGrass()),
        LOCATION(RC_KF_ADULT_GRASS_20,                        logic->IsAdult && logic->CanCollectGrass()),
        ...
        // SOH-EXTREME: the Kokiri Forest route into Lost Woods is the climb route.
        // Hookshot/bean/trick alternatives are not valid substitutes for shuffled Climb.
        ENTRANCE(RR_KF_OUTSIDE_LOST_WOODS,
                 !ctx->GetOption(RSK_SHUFFLE_CLIMB) || logic->HasItem(RG_CLIMB)),
    ...
    areaTable[RR_KF_OUTSIDE_LOST_WOODS] = Region("KF Outside Lost Woods", SCENE_KOKIRI_FOREST, {
        ...
        // SOH-EXTREME: this is the same physical climb opening as the forward
        // Kokiri Forest edge.  Keep the reverse region edge gated too so the
        // tracker cannot leak Lost Woods reachability through this helper region.
        ENTRANCE(RR_THE_LOST_WOODS,        !ctx->GetOption(RSK_SHUFFLE_CLIMB) || logic->HasItem(RG_CLIMB)),
    ...
    areaTable[RR_KF_BOULDER_LOOP] = Region("KF Boulder Loop", SCENE_KOKIRI_FOREST, {}, {
        ...
        LOCATION(RC_KF_CHILD_GRASS_MAZE_1,              logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_MAZE_2,              logic->IsChild && logic->CanCollectGrass()),
        LOCATION(RC_KF_CHILD_GRASS_MAZE_3,              logic->IsChild && logic->CanCollectGrass()),
    ...
    areaTable[RR_KF_LINKS_HOUSE] = Region("KF Link's House", SCENE_LINKS_HOUSE, {}, {
        //Locations
        LOCATION(RC_KF_LINKS_HOUSE_COW, logic->HasAnimalSoul(RG_ANIMAL_SOUL_COW) && logic->IsAdult && logic->CanUse(RG_EPONAS_SONG) && logic->Get(LOGIC_LINKS_COW)),
    ...
    areaTable[RR_KF_STORMS_GROTTO] = Region("KF Storms Grotto", SCENE_GROTTOS, grottoEvents, {
        ...
        LOCATION(RC_KF_STORMS_GROTTO_GRASS_1,                logic->CanCollectGrass()),
        LOCATION(RC_KF_STORMS_GROTTO_GRASS_2,                logic->CanCollectGrass()),
        LOCATION(RC_KF_STORMS_GROTTO_GRASS_3,                logic->CanCollectGrass()),
        LOCATION(RC_KF_STORMS_GROTTO_GRASS_4,                logic->CanCollectGrass()),
