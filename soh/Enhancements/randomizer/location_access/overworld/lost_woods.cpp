...
void RegionTable_Init_LostWoods() {
    ...
    areaTable[RR_THE_LOST_WOODS] = Region("Lost Woods", SCENE_LOST_WOODS, {
        ...
        LOCATION(RC_LW_GRASS_1,                         logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_2,                         logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_3,                         logic->CanCollectGrass()),
        ...
        ENTRANCE(RR_LW_NEAR_SHORTCUTS_GROTTO, AnyAgeTime([]{return logic->CanBreakRocks();})),
    });   
    ...
    areaTable[RR_LW_BEYOND_MIDO] = Region("LW Beyond Mido", SCENE_LOST_WOODS, {
        ...
        LOCATION(RC_LW_GRASS_4,                            logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_5,                            logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_6,                            logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_7,                            logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_8,                            logic->CanCollectGrass()),
        LOCATION(RC_LW_GRASS_9,                            logic->CanCollectGrass()),
        ...
        ENTRANCE(RR_DEKU_THEATER,     !ctx->GetOption(RSK_SHUFFLE_SHOVEL) || logic->HasItem(RG_SHOVEL)),
        ENTRANCE(RR_LW_SCRUBS_GROTTO, AnyAgeTime([]{return logic->CanBreakRocks();})),
    });
    ...
    areaTable[RR_LW_NEAR_SHORTCUTS_GROTTO] = Region("LW Near Shortcuts Grotto", SCENE_GROTTOS, grottoEvents, {
        ...
        LOCATION(RC_LW_NEAR_SHORTCUTS_GROTTO_GRASS_1,                logic->CanCollectGrass()),
        LOCATION(RC_LW_NEAR_SHORTCUTS_GROTTO_GRASS_2,                logic->CanCollectGrass()),
        LOCATION(RC_LW_NEAR_SHORTCUTS_GROTTO_GRASS_3,                logic->CanCollectGrass()),
        LOCATION(RC_LW_NEAR_SHORTCUTS_GROTTO_GRASS_4,                logic->CanCollectGrass()),
