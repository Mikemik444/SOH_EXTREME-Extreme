...
#pragma region Vanilla
    ...
    areaTable[RR_DEKU_TREE_LOBBY] = Region("Deku Tree Lobby", SCENE_DEKU_TREE, {
        ...
        //Locations
        // SOH-EXTREME: the lower lobby heart is physically on the 2F ledge.
        // Boomerang from 1F cannot reach it; require a real route to 2F instead.
        LOCATION(RC_DEKU_TREE_LOBBY_LOWER_HEART, logic->HasItem(RG_CLIMB) || logic->CanUse(RG_HOOKSHOT)),
        LOCATION(RC_DEKU_TREE_LOBBY_GRASS_1,     logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_LOBBY_GRASS_2,     logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_LOBBY_GRASS_3,     logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_LOBBY_2F] = Region("Deku Tree Lobby 2F", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_2F_GRASS_1,        logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_2F_GRASS_2,        logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_SLINGSHOT_ROOM] = Region("Deku Tree Slingshot Room", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_SLINGSHOT_GRASS_1,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_SLINGSHOT_GRASS_2,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_SLINGSHOT_GRASS_3,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_SLINGSHOT_GRASS_4,         logic->CanCollectGrass()),
    }, {
        //Exits
        ENTRANCE(RR_DEKU_TREE_2F_MIDDLE_ROOM, true),
    });
    ...
    areaTable[RR_DEKU_TREE_COMPASS_ROOM] = Region("Deku Tree Compass Room", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_COMPASS_GRASS_1,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_COMPASS_GRASS_2,         logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_BASEMENT_LOWER] = Region("Deku Tree Basement Lower", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_BASEMENT_GRASS_1,  logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_GRASS_2,  logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_BASEMENT_SCRUB_ROOM] = Region("Deku Tree Basement Scrub Room", SCENE_DEKU_TREE, {}, {
        //Location
        LOCATION(RC_DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_SCRUB_ROOM_GRASS_4, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_BASEMENT_WATER_ROOM_BACK] = Region("Deku Tree Basement Water Room Back", SCENE_DEKU_TREE, {}, {
        //Locations
        LOCATION(RC_DEKU_TREE_BASEMENT_SPIKE_ROLLER_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_SPIKE_ROLLER_GRASS_2, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_BASEMENT_TORCH_ROOM] = Region("Deku Tree Basement Torch Room", SCENE_DEKU_TREE, {
        ...
        //Locations
        LOCATION(RC_DEKU_TREE_BASEMENT_TORCHES_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_TORCHES_GRASS_2, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_BASEMENT_BACK_LOBBY] = Region("Deku Tree Basement Back Lobby", SCENE_DEKU_TREE, {
        ...
        //Location
        LOCATION(RC_DEKU_TREE_BASEMENT_LARVAE_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_BASEMENT_LARVAE_GRASS_2, logic->CanCollectGrass()),
    }, {
        //Exits
        ENTRANCE(RR_DEKU_TREE_BASEMENT_TORCH_ROOM, true),
    ...
    areaTable[RR_DEKU_TREE_OUTSIDE_BOSS_ROOM] = Region("Deku Tree Outside Boss Room", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_BEFORE_BOSS_GRASS_1,      logic->CanCollectGrass() && logic->HasFireSourceWithTorch()),
        LOCATION(RC_DEKU_TREE_BEFORE_BOSS_GRASS_2,      logic->CanCollectGrass() && logic->HasFireSourceWithTorch()),
        LOCATION(RC_DEKU_TREE_BEFORE_BOSS_GRASS_3,      logic->CanCollectGrass() && logic->HasFireSourceWithTorch()),
    }, {
        //Exits
...
#pragma region MQ
    ...
    areaTable[RR_DEKU_TREE_MQ_1F] = Region("Deku Tree MQ 1F", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_LOBBY_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_LOBBY_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_LOBBY_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_LOBBY_GRASS_4, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_LOBBY_GRASS_5, logic->CanCollectGrass()),
    }, {
        //Exits
        ENTRANCE(RR_DEKU_TREE_ENTRYWAY,    true),
    ...
    areaTable[RR_DEKU_TREE_MQ_2F] = Region("Deku Tree MQ 2F", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_2F_GRASS_1,    logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_2F_GRASS_2,    logic->CanCollectGrass()),
    ...
    areaTable[RR_DEKU_TREE_MQ_SLINGSHOT_ROOM] = Region("Deku Tree MQ Slingshot Room", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_SLINGSHOT_GRASS_1,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_SLINGSHOT_GRASS_2,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_SLINGSHOT_GRASS_3,         logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_SLINGSHOT_GRASS_4,         logic->CanCollectGrass()),
    ...
    areaTable[RR_DEKU_TREE_MQ_EYE_TARGET_ROOM] = Region("Deku Tree MQ Eye Target Room", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_4, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_5, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_6, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_COMPASS_GRASS_7, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_COMPASS_ROOM] = Region("Deku Tree MQ Compass Room", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_COMPASS_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_COMPASS_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_COMPASS_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_COMPASS_GRASS_4, logic->CanCollectGrass()),
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT] = Region("Deku Tree MQ Basement", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_LOWER_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_LOWER_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_LOWER_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_LOWER_GRASS_4, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_SOUTHEAST_ROOM] = Region("Deku Tree MQ Southeast Room", SCENE_DEKU_TREE, {
        ...
        //Locations
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_TORCHES_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_TORCHES_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_TORCHES_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_TORCHES_GRASS_4, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_WATER_ROOM_FRONT] = Region("Deku Tree MQ Basement Water Room Front", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_SPIKE_ROLLER_FRONT_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_SPIKE_ROLLER_FRONT_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_SPIKE_ROLLER_FRONT_GRASS_3, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK] = Region("Deku Tree MQ Basement Water Room Back", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_SPIKE_ROLLER_BACK_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_SPIKE_ROLLER_BACK_GRASS_2, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_SOUTHWEST_ROOM] = Region("Deku Tree MQ Basement Southwest Room", SCENE_DEKU_TREE, {}, {
        //Locations
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_LARVAE_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_LARVAE_GRASS_2, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_GRAVE_ROOM] = Region("Deku Tree MQ Basement Grave Room", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_GRAVES_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_GRAVES_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_GRAVES_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_GRAVES_GRASS_4, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_GRAVES_GRASS_5, logic->CanCollectGrass()),
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_BACK_ROOM] = Region("Deku Tree MQ Basement Back Room", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_BACK_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_BACK_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_BACK_GRASS_3, logic->CanCollectGrass()),
    }, {
        //Exits
    ...
    areaTable[RR_DEKU_TREE_MQ_BASEMENT_LEDGE] = Region("Deku Tree MQ Basement Ledge", SCENE_DEKU_TREE, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_UPPER_GRASS_1,   logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_UPPER_GRASS_2,   logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BASEMENT_UPPER_GRASS_3,   logic->CanCollectGrass()),
    ...
    areaTable[RR_DEKU_TREE_MQ_OUTSIDE_BOSS_ROOM] = Region("Deku Tree MQ Outside Boss Room", SCENE_DEKU_TREE, {}, {
        ...
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_BOSS_GRASS_1,      logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_BOSS_GRASS_2,      logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_MQ_BEFORE_BOSS_GRASS_3,      logic->CanCollectGrass()),
    }, {
        //Exits
...
#pragma endregion
    ...
    areaTable[RR_DEKU_TREE_BOSS_ROOM] = Region("Deku Tree Boss Room", SCENE_DEKU_TREE_BOSS, {
        ...
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_1, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_2, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_3, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_4, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_5, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_6, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_7, logic->CanCollectGrass()),
        LOCATION(RC_DEKU_TREE_QUEEN_GOHMA_GRASS_8, logic->CanCollectGrass()),
    }, {
        // Exits
