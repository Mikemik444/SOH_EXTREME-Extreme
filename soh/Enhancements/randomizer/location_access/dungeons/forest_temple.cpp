...
#pragma region Vanilla
    ...
    areaTable[RR_FOREST_TEMPLE_RED_POE_ROOM] = Region("Forest Temple Red Poe Room", SCENE_FOREST_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_FOREST_JOELLE, logic->CanKillEnemy(RE_MEG) && logic->CanUse(RG_FAIRY_BOW)),
    }, {
        //Locations
    ...
    areaTable[RR_FOREST_TEMPLE_BLUE_POE_ROOM] = Region("Forest Temple Blue Poe Room", SCENE_FOREST_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_FOREST_BETH, logic->CanKillEnemy(RE_MEG) && logic->CanUse(RG_FAIRY_BOW)),
    }, {
        //Locations
    ...
    areaTable[RR_FOREST_TEMPLE_GREEN_POE_ROOM] = Region("Forest Temple Green Poe Room", SCENE_FOREST_TEMPLE, {
        //Events
        EVENT_ACCESS(LOGIC_FOREST_AMY, logic->CanKillEnemy(RE_MEG) && logic->CanUse(RG_FAIRY_BOW) && logic->HasItem(RG_POWER_BRACELET)),
    }, {
        //Locations
