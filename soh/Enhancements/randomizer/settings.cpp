...
void Settings::CreateOptions() {
    ...
    OPT_U8(RSK_SHUFFLE_SPEAK, {"Off", "On", "Individual Languages"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ShuffleSpeak"), WIDGET_CVAR_COMBOBOX, 0);
    ...
    OPT_U8(RSK_SHUFFLE_ENEMY_SOUL, {"Off", "All Enemies as 1", "Individual Enemies"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ShuffleEnemySoul"), WIDGET_CVAR_COMBOBOX, 0);
    OPT_U8(RSK_ENEMY_SOUL_BEHAVIOR, {"Gone Until Found", "Invincible Until Found"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("EnemySoulBehavior"), WIDGET_CVAR_COMBOBOX, 0);
    OPT_BOOL(RSK_SHUFFLE_NPC_SOUL, CVAR_RANDOMIZER_SETTING("ShuffleNpcSoul"));
    OPT_U8(RSK_SHUFFLE_ANIMAL_SOUL, {"Off", "All Animals as 1", "Individual Animals"}, OptionCategory::Setting, CVAR_RANDOMIZER_SETTING("ShuffleAnimalSoul"), WIDGET_CVAR_COMBOBOX, 0);
    ...
    mOptionGroups[RSG_MENU_SECTION_ADDITIONAL_ITEMS] = OptionGroup::SubGroup("Additional Items",
                                                                             {
                                                                                 ...
                                                                                 &mOptions[RSK_ENEMY_SOUL_BEHAVIOR],
