...
void GenerateItemPool() {
    ...
    if (ctx->GetOption(RSK_SHUFFLE_SPEAK).Is(1)) {
        // Combined Speak: one representative item unlocks all six language flags.
        AddItemToPool(RG_SPEAK_HYLIAN, 2, 1, 1, 1);
    } else if (ctx->GetOption(RSK_SHUFFLE_SPEAK).Is(2)) {
    ...
    if (ctx->GetOption(RSK_SHUFFLE_ENEMY_SOUL).Is(1)) {
        AddItemToPool(RG_ENEMY_SOUL, 2, 1, 1, 1, false);
    } else if (ctx->GetOption(RSK_SHUFFLE_ENEMY_SOUL).Is(2)) {
        AddItemToPool(RG_ENEMY_SOUL_STALFOS, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_OCTOROK, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_WALLMASTER, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_DODONGO, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_KEESE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_TEKTITE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_PEAHAT, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_LIZALFOS_DINOLFOS, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_GOHMA_LARVA, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_SHABOM, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_BABY_DODONGO, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_BIRI_BARI, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_TAILPASARAN, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_TORCH_SLUG, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_MOBLIN, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_ARMOS, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_DEKU_BABA, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_DEKU_SCRUB, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_BUBBLE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_BEAMOS, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_FLOORMASTER, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_REDEAD_GIBDO, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_FLARE_DANCER, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_DEAD_HAND, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_SHELL_BLADE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_LIKE_LIKE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_SPIKE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_ANUBIS, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_IRON_KNUCKLE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_SKULL_KID, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_FLYING_POT, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_FREEZARD, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_STINGER, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_WOLFOS, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_GUAY, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_JABU_TENTACLE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_DARK_LINK, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_DOOR_TRAP, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_FLYING_FLOOR_TILE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_GERUDO_THIEF, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_POE_SISTER, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_POE, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_LEEVER, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_STALCHILD, 2, 1, 1, 1, false);
        AddItemToPool(RG_ENEMY_SOUL_BIG_OCTO, 2, 1, 1, 1, false);

    }
    if (ctx->GetOption(RSK_SHUFFLE_NPC_SOUL)) { AddItemToPool(RG_NPC_SOUL, 2, 1, 1, 1, false); }
    if (ctx->GetOption(RSK_SHUFFLE_ANIMAL_SOUL).Is(1)) {
        AddItemToPool(RG_ANIMAL_SOUL, 2, 1, 1, 1, false);
    } else if (ctx->GetOption(RSK_SHUFFLE_ANIMAL_SOUL).Is(2)) {
        AddItemToPool(RG_ANIMAL_SOUL_COW, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_CUCCO, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_DOG, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_FISH, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_BUG, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_BUTTERFLY, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_FROG, 2, 1, 1, 1, false);
        AddItemToPool(RG_ANIMAL_SOUL_HORSE, 2, 1, 1, 1, false);
    }
