...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.ROOT_EXITS, world, [
        ...
        (Regions.MINUET_OF_FOREST_WARP, lambda bundle: can_play_song(Items.MINUET_OF_FOREST, bundle)),
        (Regions.BOLERO_OF_FIRE_WARP, lambda bundle: can_play_song(Items.BOLERO_OF_FIRE, bundle)),
        (Regions.SERENADE_OF_WATER_WARP, lambda bundle: can_play_song(Items.SERENADE_OF_WATER, bundle)),
        (Regions.NOCTURNE_OF_SHADOW_WARP, lambda bundle: can_play_song(Items.NOCTURNE_OF_SHADOW, bundle)),
        (Regions.REQUIEM_OF_SPIRIT_WARP, lambda bundle: can_play_song(Items.REQUIEM_OF_SPIRIT, bundle)),
        (Regions.PRELUDE_OF_LIGHT_WARP, lambda bundle: can_play_song(Items.PRELUDE_OF_LIGHT, bundle)),
    ])
