...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.ZR_FRONT, world, [
        ...
        (Locations.ZR_NEAR_TREE_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS4, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS5, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS6, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS7, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS8, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS9, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS10, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS11, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_NEAR_TREE_GRASS12, lambda bundle: can_collect_grass(bundle)),
    ...
    add_locations(Regions.ZORA_RIVER, world, [
        ...
        (Locations.ZR_FROGS_SONG_OF_TIME, lambda bundle: is_child(bundle) &
         can_use(Items.SONG_OF_TIME, bundle)),
        (Locations.ZR_NEAR_OPEN_GROTTO_FREESTANDING_POH, lambda bundle:
    ...
    add_locations(Regions.ZR_OPEN_GROTTO, world, [
        ...
        (Locations.ZR_OPEN_GROTTO_BEEHIVE_RIGHT,
         lambda bundle: can_break_lower_hives(bundle)),
        (Locations.ZR_OPEN_GROTTO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_OPEN_GROTTO_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_OPEN_GROTTO_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.ZR_OPEN_GROTTO_GRASS4, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
