...
class SohExtremeWorld(CachedRuleBuilderWorld):
    ...
    def create_regions(self) -> None:
        ...
        native_region_aliases = {
            # The native token says AREA; the AP enum says REGION. Without this
            # alias, the native block/switch Grab gate cannot be projected.
            "DODONGOS_CAVERN_BOSS_AREA": "DODONGOS_CAVERN_BOSS_REGION",
