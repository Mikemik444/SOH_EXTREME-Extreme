...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.DODONGOS_CAVERN_BOSS_REGION, world, [
        ...
        (Regions.DODONGOS_CAVERN_BACK_ROOM,
         lambda bundle: can_break_mud_walls(bundle)),
        # The block must hold the switch down. Both ages need Grab when it is
        # shuffled; strength/explosives alone are not a substitute for pushing.
        (Regions.DODONGOS_CAVERN_BOSS_ENTRYWAY, lambda bundle: can_grab(bundle)),
    ])
