...
class EventLocations(StrEnum):
    DEKU_TREE_LOBBY_WEB_BURNED = "Deku Tree Lobby Web Burned"
    DEKU_TREE_LOBBY_WEB_JUMPED = "Deku Tree Lobby Web Jumped"
...
class LocalEvents(StrEnum):
    DEKU_TREE_LOBBY_WEB_BROKEN = "Deku Tree Lobby Web Broken"
...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.DEKU_TREE_ENTRYWAY, world, [
        (Regions.DEKU_TREE_LOBBY, lambda bundle: True_() ),
        (Regions.KF_OUTSIDE_DEKU_TREE, lambda bundle: True_() )
    ])

    # Deku Lobby
    # Events
    add_events(Regions.DEKU_TREE_LOBBY, world, [
        (EventLocations.DEKU_TREE_LOBBY_WEB_BURNED, LocalEvents.DEKU_TREE_LOBBY_WEB_BROKEN,
    ...
    add_locations(Regions.DEKU_TREE_LOBBY, world, [
        (Locations.DEKU_TREE_LOBBY_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DEKU_TREE_LOBBY_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.DEKU_TREE_LOBBY_GRASS3, lambda bundle: can_collect_grass(bundle)),
    ])
    # Match native deku_tree.cpp. A weapon on 1F is not a route to 3F or B1.
    def climb(bundle):
        return Has("Climb") if world.options.shuffle_climb.value else True_()

    connect_regions(Regions.DEKU_TREE_LOBBY, world, [
        (Regions.DEKU_TREE_ENTRYWAY, lambda bundle: True_()),
        (Regions.DEKU_TREE_LOBBY_2F, lambda bundle: climb(bundle) | can_use(Items.HOOKSHOT, bundle)),
        (Regions.DEKU_TREE_BASEMENT_LOWER,
         lambda bundle: has_item(LocalEvents.DEKU_TREE_LOBBY_WEB_BROKEN, bundle)),
    ])
    add_locations(Regions.DEKU_TREE_LOBBY_2F, world, [
        (Locations.DEKU_TREE_MAP_CHEST, lambda bundle: True_()),
        (Locations.DEKU_TREE_LOBBY_LOWER_HEART, lambda bundle: True_()),
        (Locations.DEKU_TREE_2F_GRASS_1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DEKU_TREE_2F_GRASS_2, lambda bundle: can_collect_grass(bundle)),
    ])
    connect_regions(Regions.DEKU_TREE_LOBBY_2F, world, [
        (Regions.DEKU_TREE_LOBBY, lambda bundle: True_()),
        (Regions.DEKU_TREE_LOBBY_3F, lambda bundle: climb(bundle) | can_use(Items.LONGSHOT, bundle)),
        (Regions.DEKU_TREE_2F_MIDDLE_ROOM, lambda bundle: True_()),
    ])
    add_events(Regions.DEKU_TREE_LOBBY_3F, world, [
        (EventLocations.DEKU_TREE_LOBBY_WEB_JUMPED, LocalEvents.DEKU_TREE_LOBBY_WEB_BROKEN,
         lambda bundle: can_pass_enemy(bundle, Enemies.BIG_SKULLTULA)),
    ])
    add_locations(Regions.DEKU_TREE_LOBBY_3F, world, [
        (Locations.DEKU_TREE_LOBBY_UPPER_HEART,
         lambda bundle: can_pass_enemy(bundle, Enemies.BIG_SKULLTULA)),
    ])
    connect_regions(Regions.DEKU_TREE_LOBBY_3F, world, [
        (Regions.DEKU_TREE_LOBBY_2F, lambda bundle: True_()),
        (Regions.DEKU_TREE_COMPASS_ROOM, lambda bundle: True_()),
    ])
    ...
    add_locations(Regions.DEKU_TREE_SLINGSHOT_ROOM, world, [
        (Locations.DEKU_TREE_SLINGSHOT_CHEST, lambda bundle: True_() ),
        (Locations.DEKU_TREE_SLINGSHOT_ROOM_SIDE_CHEST, lambda bundle: True_() ),
        (Locations.DEKU_TREE_SLINGSHOT_GRASS1, lambda bundle: can_collect_grass(
            bundle) & can_reflect_nuts(bundle)),
        (Locations.DEKU_TREE_SLINGSHOT_GRASS2, lambda bundle: can_collect_grass(
            bundle) & can_reflect_nuts(bundle)),
        (Locations.DEKU_TREE_SLINGSHOT_GRASS3, lambda bundle: can_collect_grass(
            bundle) & can_reflect_nuts(bundle)),
        (Locations.DEKU_TREE_SLINGSHOT_GRASS4, lambda bundle: can_collect_grass(
            bundle) & can_reflect_nuts(bundle))
    ])
    # Connections
    ...
    add_locations(Regions.DEKU_TREE_COMPASS_ROOM, world, [
        (Locations.DEKU_TREE_COMPASS_CHEST, lambda bundle: True_() ),
        (Locations.DEKU_TREE_COMPASS_ROOM_SIDE_CHEST, lambda bundle: True_() ),
        (Locations.DEKU_TREE_GS_COMPASS_ROOM,
         lambda bundle: can_kill_enemy(bundle, Enemies.GOLD_SKULLTULA)),
        (Locations.DEKU_TREE_COMPASS_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DEKU_TREE_COMPASS_GRASS2, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
    connect_regions(Regions.DEKU_TREE_COMPASS_ROOM, world, [
        (Regions.DEKU_TREE_LOBBY_3F, lambda bundle: has_fire_source_with_torch(bundle)
    ...
    add_locations(Regions.DEKU_TREE_BASEMENT_LOWER, world, [
        (Locations.DEKU_TREE_BASEMENT_CHEST, lambda bundle: True_() ),
    ...
    connect_regions(Regions.DEKU_TREE_BASEMENT_LOWER, world, [
        (Regions.DEKU_TREE_LOBBY, lambda bundle: climb(bundle) | can_use(Items.LONGSHOT, bundle)),
        (Regions.DEKU_TREE_BASEMENT_SCRUB_ROOM, lambda bundle: has_fire_source_with_torch(
            bundle) | can_use(Items.FAIRY_BOW, bundle)),
        (Regions.DEKU_TREE_BASEMENT_UPPER, lambda bundle: is_adult(bundle) | can_do_trick(Tricks.DEKU_B1_SKIP, bundle)
            | has_item(LocalEvents.DEKU_TREE_BASEMENT_UPPER_BLOCK_PUSHED, bundle) | can_ground_jump(bundle))
    ])
    ...
    connect_regions(Regions.DEKU_TREE_BASEMENT_WATER_ROOM_FRONT, world, [
        (Regions.DEKU_TREE_BASEMENT_SCRUB_ROOM, lambda bundle: True_() ),
        (Regions.DEKU_TREE_BASEMENT_WATER_ROOM_BACK, lambda bundle: has_item(
            Items.BRONZE_SCALE, bundle) | can_do_trick(Tricks.DEKU_B1_BACKFLIP_OVER_SPIKED_LOG, bundle)),
    ])
    ...
    add_locations(Regions.DEKU_TREE_BASEMENT_TORCH_ROOM, world, [
        (Locations.DEKU_TREE_TORCHES_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DEKU_TREE_TORCHES_GRASS2, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
    ...
    add_locations(Regions.DEKU_TREE_BASEMENT_BACK_LOBBY, world, [
        (Locations.DEKU_TREE_LARVAE_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DEKU_TREE_LARVAE_GRASS2, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
    ...
    connect_regions(Regions.DEKU_TREE_BASEMENT_BACK_ROOM, world, [
        (Regions.DEKU_TREE_BASEMENT_BACK_LOBBY, lambda bundle: True_() ),
    ])
    ...
    add_events(Regions.DEKU_TREE_BASEMENT_UPPER, world, [
        ...
        (EventLocations.DEKU_TREE_BASEMENT_UPPER_BLOCK,
         LocalEvents.DEKU_TREE_BASEMENT_UPPER_BLOCK_PUSHED, lambda bundle: True_() )
    ])
    # Connections
    ...
    add_locations(Regions.DEKU_TREE_OUTSIDE_BOSS_ROOM, world, [
        (Locations.DEKU_TREE_FINAL_ROOM_LEFT_FRONT_HEART, lambda bundle: has_item(Items.BRONZE_SCALE,
         bundle) | can_use(Items.IRON_BOOTS, bundle) | can_use(Items.IRON_BOOTS, bundle)),
        ...
        (Locations.DEKU_TREE_FINAL_ROOM_RIGHT_HEART, lambda bundle: has_item(Items.BRONZE_SCALE,
         bundle) | can_use(Items.IRON_BOOTS, bundle) | can_use(Items.IRON_BOOTS, bundle)),
        (Locations.DEKU_TREE_BEFORE_BOSS_GRASS1, lambda bundle: can_collect_grass(
            bundle) & has_fire_source_with_torch(bundle)),
        (Locations.DEKU_TREE_BEFORE_BOSS_GRASS2, lambda bundle: can_collect_grass(
            bundle) & has_fire_source_with_torch(bundle)),
        (Locations.DEKU_TREE_BEFORE_BOSS_GRASS3, lambda bundle: can_collect_grass(
            bundle) & has_fire_source_with_torch(bundle))
    ])
    # Connections
    ...
    connect_regions(Regions.DEKU_TREE_BOSS_ENTRYWAY, world, [
        (Regions.DEKU_TREE_BOSS_ROOM, lambda bundle: True_() )
    ])

    # Deku boss exit
    # Connections
    connect_regions(Regions.DEKU_TREE_BOSS_EXIT, world, [
        (Regions.DEKU_TREE_OUTSIDE_BOSS_ROOM, lambda bundle: True_() ),
    ...
    connect_regions(Regions.DEKU_TREE_BOSS_ROOM, world, [
        (Regions.DEKU_TREE_BOSS_EXIT, lambda bundle: True_() ),
