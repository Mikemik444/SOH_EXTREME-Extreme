...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.KAKARIKO_VILLAGE, world, [
        ...
        (Locations.KAK_NEAR_GUARDS_HOUSE_POT3,
         lambda bundle: is_child(bundle) & can_break_pots(bundle)),
        (Locations.KAK_TREE_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_TREE_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_TREE_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_TREE_GRASS4, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_TREE_GRASS5, lambda bundle: can_collect_grass(bundle)),
    ...
    add_locations(Regions.KAK_OPEN_GROTTO, world, [
        ...
        (Locations.KAK_OPEN_GROTTO_BEEHIVE_RIGHT,
         lambda bundle: can_break_lower_hives(bundle)),
        (Locations.KAK_OPEN_GROTTO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_OPEN_GROTTO_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_OPEN_GROTTO_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.KAK_OPEN_GROTTO_GRASS4, lambda bundle: can_collect_grass(bundle)),
    ])
    # Connections
