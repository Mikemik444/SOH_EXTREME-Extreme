...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.LOST_WOODS, world, [
        ...
        (Locations.LW_UNDERWATER_SHORTCUT_RUPEE1,
         lambda bundle: is_child(bundle) & can_swim(bundle) & has_item(Items.GOLDEN_SCALE, bundle)),
        ...
        (Locations.LW_SHORTCUTS_SONG_OF_STORMS_FAIRY,
         lambda bundle: can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.LW_NEAR_SHORTCUTS_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_NEAR_SHORTCUTS_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_NEAR_SHORTCUTS_GRASS3, lambda bundle: can_collect_grass(bundle)),
    ])
    # Connections
    ...
    add_locations(Regions.LW_BEYOND_MIDO, world, [
        ...
        (Locations.LW_BEAN_SPROUT_NEAR_THEATRE_FAIRY3,
         lambda bundle: is_child(bundle) & has_item(Items.MAGIC_BEAN, bundle) & can_use(Items.SONG_OF_STORMS,
                                                                                            bundle)),
        (Locations.LW_AFTER_MIDO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_AFTER_MIDO_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_AFTER_MIDO_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_NEAR_SFM_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_NEAR_SFM_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.LW_NEAR_SFM_GRASS3, lambda bundle: can_collect_grass(bundle)),
    ])
    # Connections
