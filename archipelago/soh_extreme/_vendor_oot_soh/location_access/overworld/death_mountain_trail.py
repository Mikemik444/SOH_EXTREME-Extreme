...
def set_region_rules(world: "SohWorld") -> None:
    ...
    connect_regions(Regions.DEATH_MOUNTAIN_TRAIL, world, [
        ...
        # This AP edge contracts Trail -> Rockfall -> Summit. Preserve BOTH
        # obstacles: removing/bypassing the rocks, then the climb and rockfall.
        # Bombchus are a method, never a substitute for Rock / Boulder Soul.
        (Regions.DEATH_MOUNTAIN_SUMMIT, lambda bundle:
            can_climb(bundle)
            & (can_break_rocks(bundle) | (is_adult(bundle) & (
                (has_item(LocalEvents.DMT_BEAN_PLANTED, bundle) & has_item(Items.GORONS_BRACELET, bundle))
                | (can_use(Items.HOVER_BOOTS, bundle) & can_do_trick(Tricks.DMT_CLIMB_HOVERS, bundle)))))
    ...
    add_locations(Regions.DMT_COW_GROTTO, world, [
        ...
        (Locations.DMT_COW_GROTTO_SONG_OF_STORMS_FAIRY,
         lambda bundle: can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.DMT_COW_GROTTO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMT_COW_GROTTO_GRASS2, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
    ...
    add_locations(Regions.DMT_STORMS_GROTTO, world, [
        ...
        (Locations.DMT_STORMS_GROTTO_BEEHIVE_RIGHT,
         lambda bundle: can_break_lower_hives(bundle)),
        (Locations.DMT_STORMS_GROTTO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMT_STORMS_GROTTO_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMT_STORMS_GROTTO_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMT_STORMS_GROTTO_GRASS4, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
