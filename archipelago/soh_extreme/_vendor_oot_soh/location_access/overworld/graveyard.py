...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.THE_GRAVEYARD, world, [
        ...
        (Locations.GRAVEYARD_BEAN_SPROUT_FAIRY3, lambda bundle: is_child(bundle) & can_use(
            Items.MAGIC_BEAN, bundle) & can_use(Items.SONG_OF_STORMS, bundle)),
        (Locations.GRAVEYARD_GRASS_1, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_2, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_3, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_4, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_5, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_6, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_7, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_8, lambda bundle: can_collect_grass(bundle)),
        (Locations.GRAVEYARD_GRASS_9, lambda bundle: can_collect_grass(bundle)),
    ...
    connect_regions(Regions.THE_GRAVEYARD, world, [
        (Regions.GRAVEYARD_SHIELD_GRAVE,
         lambda bundle: can_grab(bundle) & (is_adult(bundle) | at_night(bundle))),
        (Regions.GRAVEYARD_COMPOSERS_GRAVE,
         lambda bundle: can_use(Items.ZELDAS_LULLABY, bundle)),
        (Regions.GRAVEYARD_HEART_PIECE_GRAVE,
         lambda bundle: can_grab(bundle) & (is_adult(bundle) | at_night(bundle))),
        (Regions.GRAVEYARD_DAMPES_GRAVE, lambda bundle: can_grab(bundle) & is_adult(bundle)),
