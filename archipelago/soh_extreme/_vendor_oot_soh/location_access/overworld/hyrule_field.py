...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.HYRULE_FIELD, world, [
        ...
        (Locations.HF_CENTRAL_GRASS1, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS2, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS3, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS4, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS5, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS6, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS7, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS8, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS9, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS10, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS11, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_CENTRAL_GRASS12, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS1, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS2, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS3, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS4, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS5, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS6, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS7, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS8, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS9, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS10, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS11, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_SOUTH_GRASS12, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS1, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS2, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS3, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS4, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS5, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS6, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS7, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS8, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS9, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS10, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS11, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_MARKET_GRASS12, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS1, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS2, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS3, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS4, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS5, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS6, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS7, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS8, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS9, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS10, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS11, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_NEAR_KFGRASS12, lambda bundle: (can_collect_grass(bundle))),
    ...
    connect_regions(Regions.HYRULE_FIELD, world, [
        ...
        # The Field fence needs the ladder or a usable adult Epona route.
        (Regions.LAKE_HYLIA, lambda bundle: can_climb(bundle) | can_use(Items.EPONA, bundle)),
        (Regions.GERUDO_VALLEY, lambda bundle: True_()),
        (Regions.MARKET_ENTRANCE, lambda bundle: is_adult(bundle) | at_day(bundle)),
    ...
    add_locations(Regions.HF_OPEN_GROTTO, world, [
        ...
        (Locations.HF_OPEN_GROTTO_BEEHIVE_RIGHT,
         lambda bundle: (can_break_lower_hives(bundle))),
        (Locations.HF_OPEN_GROTTO_GRASS1, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_OPEN_GROTTO_GRASS2, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_OPEN_GROTTO_GRASS3, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_OPEN_GROTTO_GRASS4, lambda bundle: (can_collect_grass(bundle)))
    ])
    # Connections
    ...
    add_locations(Regions.HF_COW_GROTTO_BEHIND_WEBS, world, [
        ...
        (Locations.HF_COW_GROTTO_GRASS1, lambda bundle: (can_collect_grass(bundle))),
        (Locations.HF_COW_GROTTO_GRASS2, lambda bundle: (can_collect_grass(bundle))),
    ])
    # Connections
