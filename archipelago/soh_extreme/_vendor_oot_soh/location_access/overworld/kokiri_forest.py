...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.KOKIRI_FOREST, world, [
        ...
        (Locations.KF_CHILD_GRASS1, lambda bundle: (
            is_child(bundle) & can_collect_grass(bundle))),
        ...
        (Locations.KF_ADULT_GRASS1, lambda bundle: (
            is_adult(bundle) & can_collect_grass(bundle))),
    ...
    add_locations(Regions.KF_STORMS_GROTTO, world, [
        ...
        (Locations.KF_STORMS_GROTTO_BEEHIVE_RIGHT,
         lambda bundle: can_break_lower_hives(bundle)),
        (Locations.KF_STORMS_GROTTO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.KF_STORMS_GROTTO_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.KF_STORMS_GROTTO_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.KF_STORMS_GROTTO_GRASS4, lambda bundle: can_collect_grass(bundle)),
    ])
    # Connections
