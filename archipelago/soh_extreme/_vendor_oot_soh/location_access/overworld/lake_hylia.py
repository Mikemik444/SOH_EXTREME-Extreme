...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.LAKE_HYLIA, world, [
        ...
        (Locations.LH_ISLAND_SUNS_SONG_FAIRY, lambda bundle: can_use(Items.SUNS_SONG, bundle) &
         ((has_item(Items.BRONZE_SCALE, bundle) &
           (is_child(bundle) |
            has_item(Events.WATER_TEMPLE_COMPLETED, bundle))) |
          can_use(Items.DISTANT_SCARECROW, bundle))),
        (Locations.LH_GRASS_1, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_2, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_3, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_4, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_5, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_6, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_7, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_8, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_9, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_10, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_11, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_12, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_13, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_14, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_15, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_16, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_17, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_18, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_19, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_20, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_21, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_22, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_23, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_24, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_25, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_26, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_27, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_28, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_29, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_30, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_31, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_32, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_33, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_34, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_35, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_GRASS_36, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_CHILD_GRASS_1, lambda bundle: is_child(bundle) &
         can_collect_grass(bundle)),
        ...
        (Locations.LH_CHILD_GRASS_4, lambda bundle: is_child(bundle) &
         can_collect_grass(bundle)),
        (Locations.LH_WARP_PAD_GRASS_1, lambda bundle: can_collect_grass(bundle)),
        (Locations.LH_WARP_PAD_GRASS_2, lambda bundle: can_collect_grass(bundle)),
    ])
    # Connections
    ...
    connect_regions(Regions.LH_FROM_SHORTCUT, world, [
        # Voiding without Swim returns to the last entrance; it cannot create
        # access to Lake Hylia on the other side of this water transition.
        (Regions.LAKE_HYLIA, lambda bundle: can_swim(bundle)),
