...
def set_region_rules(world: "SohWorld") -> None:
    ...
    add_locations(Regions.DMC_UPPER_GROTTO, world, [
        ...
        (Locations.DMC_UPPER_GROTTO_BEEHIVE_RIGHT,
         lambda bundle: can_break_lower_hives(bundle)),
        (Locations.DMC_UPPER_GROTTO_GRASS1, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMC_UPPER_GROTTO_GRASS2, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMC_UPPER_GROTTO_GRASS3, lambda bundle: can_collect_grass(bundle)),
        (Locations.DMC_UPPER_GROTTO_GRASS4, lambda bundle: can_collect_grass(bundle))
    ])
    # Connections
