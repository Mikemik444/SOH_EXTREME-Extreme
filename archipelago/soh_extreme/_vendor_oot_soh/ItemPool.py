...
def create_item_pool(world: "SohWorld") -> None:
    ...
    if world.options.bombchu_bag == "single_bag":
        # SOH-EXTREME: bags and ammunition are separate items. Keep the
        # normal 5/10/20-pack quantities as refills even in single-bag mode.
        # Receiving an ammo pack must never grant the bag in the native client.
